...
///
/// All tuning numbers live here so widgets and controllers never hard-code XP
/// values. Overridable via [xpConfigProvider]. Level/rank progression lives in
/// the separate [LevelService]; this service only computes per-case rewards.
...
/// Computes XP rewards from the configured rules.
///
